...
const api = {
  ...
  getTechnologyCategories: async () => api.fetchJson(`${config.apiBaseUrl}/technologyCategory`),
  ...
  getAppRefModelDomainGroups: async () => api.fetchJson(`${config.apiBaseUrl}/appReferenceModelDomainGroup`),
  getAppRefModelDomains: async () => api.fetchJson(`${config.apiBaseUrl}/appReferenceModelDomain`),
  getAppRefModelTechnologies: async () => api.fetchJson(`${config.apiBaseUrl}/appReferenceModelTechnology`),
