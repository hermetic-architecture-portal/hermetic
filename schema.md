...
```yaml
# appReferenceModelDomainGroups: optional array
# appReferenceModelDomainGroups: Application Reference Model domains groups organise the clusters of domains in the models
appReferenceModelDomainGroups:
  - armDomainGroupId: string
    # displayOrder: optional number
    # displayOrder: This field controls the display order.  Lower numbers appear sooner.
    displayOrder: 42
    name: string
# appReferenceModelDomains: optional array
# appReferenceModelDomains: Application Reference Model domains represent the spheres of activity defined in the model
appReferenceModelDomains:
    # armDomainGroupId: refers to appReferenceModelDomainGroups.[].armDomainGroupId
  - armDomainGroupId: string
    armDomainId: string
    # displayOrder: optional number
    # displayOrder: This field controls the display order.  Lower numbers appear sooner.
    displayOrder: 42
    name: string
    # parentArmDomainId: optional refers to appReferenceModelDomains.[].armDomainId
    parentArmDomainId: string
...
technologies:
    # additionalVendors: optional array
    # additionalVendors: Other vendors who have a relationship to the technology, e.g. providing contracted support
  - additionalVendors:
        # relationship: optional
      - relationship: string
        # vendorId: refers to vendors.[].vendorId
        vendorId: string
    # aka: optional
    # aka: Alternative name for technology
    aka: string
    # armDomainId: optional refers to appReferenceModelDomains.[].armDomainId
    # armDomainId: The domain ID identifies how the technology is represented in the Application Reference Model
    armDomainId: string
    ...
    # externalIdentifiers: optional array
    # externalIdentifiers: A list of references to identifiers in external systems, e.g. SKUs
    externalIdentifiers:
    - string
    ...
    technicalLinks:
      ...
      - text: string
        # url: The web URL
        url: string
    # technologyCategoryId: optional refers to technologyCategories.[].technologyCategoryId
    ...
    # vendorId: optional refers to vendors.[].vendorId
    vendorId: string
# technologyCategories: optional array
technologyCategories:
  - name: string
    technologyCategoryId: string
# technologyCosts: optional array
technologyCosts:
  - category: string
    # cost: number
    cost: 42
    # technologyId: optional refers to technologies.[].technologyId
    technologyId: string
    # vendorId: optional refers to vendors.[].vendorId
    vendorId: string
    # year: number
  ...
  - capabilityTypeId: string
    ...
    valueChainSegments:
      ...
      - displayOrder: 42
        name: string
        valueChainSegmentId: string
# vendors: optional array
vendors:
    # externalIdentifiers: optional array
    # externalIdentifiers: A list of references to identifiers in external systems
  - externalIdentifiers:
    - string
    name: string
    vendorId: string
